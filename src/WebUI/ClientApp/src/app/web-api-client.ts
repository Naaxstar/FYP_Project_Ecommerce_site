...
export interface IBookingClient {
    create(command: GetBookings | null | undefined): Observable<Booking[]>;
}
...
export class BookingClient implements IBookingClient {
    ...
    protected processCreate(response: HttpResponseBase): Observable<Booking[]> {
...
export class GetBookings implements IGetBookings {

    constructor(data?: IGetBookings) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): GetBookings {
        data = typeof data === 'object' ? data : {};
        let result = new GetBookings();
        result.init(data);
        return result;
    }
